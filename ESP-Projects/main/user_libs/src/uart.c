...
void UART_setup()
{
    ...
    uart_driver_install(UART_NUM_0, 1024 * 2, 1024*2, 1, NULL, 0);
    uart_param_config(UART_NUM_0, &uart_config);
    uart_set_pin(UART_NUM_0, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE); // 43 & 44 on esps3 23, 24 c5
