...
void app_main()
{
    ...
    xTaskCreatePinnedToCore((void *)(one_robot_control_can_task), "uart_can", 4096, NULL, 8, &control_can_handle, 0);
    ...
    xTaskCreatePinnedToCore((void *)(UART_tx_task), "uart_tx", 4096, NULL, 7, &uart_tx_handle, 1);
    xTaskCreatePinnedToCore((void *)(CAN_enable_task), "can_enable", 4096, NULL, 10, &can_enable_handle, 0);
