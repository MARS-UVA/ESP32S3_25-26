...
static const twai_timing_config_t t_config = TWAI_TIMING_CONFIG_1MBITS();     // allow all CAN IDs
static const twai_filter_config_t f_config = TWAI_FILTER_CONFIG_ACCEPT_ALL(); // don't filter out any IDs
...
twai_message_t break_msg = {
    ...
    .identifier = 0x2047C00 | 0x1b,
    .data_length_code = 8,
    .data = {0x21, 0x6E, 0x08, 0x01, 0x00, 0x00, 0x00, 0xAA},
};
