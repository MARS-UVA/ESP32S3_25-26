...
void app_main()
{
    ...
    xTaskCreatePinnedToCore((void *)(construction_robot_control_can_task), "uart_can", 4096, NULL, configMAX_PRIORITIES - 1, &control_can_handle, 0);
    xTaskCreatePinnedToCore((void *)(UART_rx_task), "uart_rx", 4096, NULL, 7, &uart_rx_handle, 0);
